...
def auto_work_order_on_production_plan_submit_enabled():
	return bool(frappe.db.get_single_value("URY Production Settings", "enable_auto_work_order_on_production_plan_submit"))
