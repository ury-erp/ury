...
def notify_print_failure(invoice, print_job_id, printer_name, reason):
...
def notify_long_running_print(invoice, print_job_id, printer_name):
    ...
    frappe.publish_realtime("invoice_print_long_running", payload)
