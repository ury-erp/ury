              ...
              {tables.map(table => (
                <Button
                  ...
                  className={cn(
                    ...
                    selectedTable === table.name
                      ...
                      : table.occupied === 1
                      ? 'border-primary-tint-border bg-card hover:border-primary-tint-border hover:bg-card'
                ...
                >
                  <TableShapeIcon
                    ...
                    className={cn(
                      'w-8 h-8',
                      // Occupied tables show accent icon; free tables show tertiary
                      table.occupied === 1 ? 'text-primary' : 'text-text-tertiary'
                    )}
                  />
