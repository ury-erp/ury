    ...
    <div className="space-y-4 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 pb-3 border-b border-border -mx-6 px-6 -mt-6 pt-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            className="border-border text-muted-foreground font-semibold flex items-center gap-1.5 whitespace-nowrap"
          >
            ...
            <div key={item.name || idx} className="bg-card rounded-lg shadow-sm overflow-hidden transition-shadow relative h-56 flex flex-col group">
              ...
              <div className="flex-1 p-3 flex flex-col">
                ...
                <div className="h-5 mt-1">
                  <p className="text-xs text-text-tertiary truncate" title={item.course || ''}>{item.course || ' '}</p>
                </div>
                <div className="mt-auto pt-2 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="p-1.5 text-text-tertiary hover:text-primary hover:bg-primary/5 rounded-md transition-colors -mr-1.5 -mb-1.5"
                    title="Edit Item"
                  >
      ...
      >
        <form onSubmit={handleSaveItem} className="space-y-5 text-sm">
          <div>
            <label className="block font-semibold text-muted-foreground mb-1.5">Target Menu <span className="text-destructive">*</span></label>
            <SearchableSelect
              id="target_menu"
          ...
          <div>
            <label className="block font-semibold text-muted-foreground mb-1.5">Item Name <span className="text-destructive">*</span></label>
            <Input
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="block font-semibold text-muted-foreground">Course</label>
              <button
                type="button"
          ...
          <div>
            <label className="block font-semibold text-muted-foreground mb-1.5">Standard Rate (₹) <span className="text-destructive">*</span></label>
            <Input
              type="number"
              value={newItem.rate}
      ...
      >
        <form onSubmit={handleSaveMenu} className="space-y-5 text-sm">
          <div>
            <label className="block font-semibold text-muted-foreground mb-1.5">Menu Name <span className="text-destructive">*</span></label>
            <Input
      ...
      >
        <form onSubmit={handleSaveCourse} className="space-y-5 text-sm">
          <div>
            <label className="block font-semibold text-muted-foreground mb-1.5">Course Name <span className="text-destructive">*</span></label>
            <Input
              value={newCourseName}
          ...
          <div>
            <label className="block font-semibold text-muted-foreground mb-1.5">Icon</label>
            <Select
              value={newCourseIcon}
