        ...
        <div className="flex-1 max-w-md mx-4 hidden md:block">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search orders, menu, tables, reports..."
              className="w-full pl-10 pr-9 py-2 bg-gray-50 hover:bg-gray-100/80 focus:bg-white text-sm text-gray-900 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#7C3AED] focus:border-transparent transition-all placeholder:text-gray-400"
            />
            {filterContext.searchQuery && (
              <button
                onClick={() => filterContext.setSearchQuery('')}
